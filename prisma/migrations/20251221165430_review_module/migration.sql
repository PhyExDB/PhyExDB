/*
  ...
  - You are about to drop the column `text2` on the `LegalDocument` table. All the data in the column will be lost.
...
-- CreateEnum
CREATE TYPE "ExperimentStatus" AS ENUM ('DRAFT', 'IN_REVIEW', 'PUBLISHED', 'REJECTED');

-- AlterTable
ALTER TABLE "LegalDocument" DROP COLUMN "text2";
...
CREATE TABLE "SectionCriticism" (
    ...
    CONSTRAINT "SectionCriticism_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "SectionCriticism_reviewId_sectionContentId_key" ON "SectionCriticism"("reviewId", "sectionContentId");
...
-- AddForeignKey
ALTER TABLE "SectionCriticism" ADD CONSTRAINT "SectionCriticism_reviewId_fkey" FOREIGN KEY ("reviewId") REFERENCES "Review"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SectionCriticism" ADD CONSTRAINT "SectionCriticism_sectionContentId_fkey" FOREIGN KEY ("sectionContentId") REFERENCES "ExperimentSectionContent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
